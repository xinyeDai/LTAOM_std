...
int main(int argc, char **argv)
{
    ...
    ROS_INFO("****************");
    ros::NodeHandle nh;
    nh.param<std::string>("common/hesai_topic", hesai_topic, "/driver/hslidar_left/hesai/pandar");
    std::string lidar_topic;
    ros::param::get("lidar_topic", lidar_topic); // Retrieve the topic name parameter
    if (argc < 3)
    {
        ROS_ERROR(
